...
from exp_builder.exp_pretraining import training, test
from exp_builder.exp_long_term_forecasting import training_long_term_forecasting, test_long_term_forecasting

from data_provider import create_dataloader_pretrain, create_dataloader_finetuning
...
def main(cfg):
    ...
    if cfg.DATASET.pretrain:
        trn_dataloader, valid_dataloader, test_dataloader = create_dataloader_pretrain(
        ...
        trn_dataloader, valid_dataloader, test_dataloader = create_dataloader_finetuning(
    ...
    if cfg.DATASET.pretrain:
        ...
        _logger.info('test_metrics: {}'.format(test_metrics))
        json.dump(test_metrics, open(os.path.join(savedir, f'test_results.json'),'w')
