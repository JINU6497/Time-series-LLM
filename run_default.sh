python main.py \
    ...
    MODEL.modelname TMAE1 \
    DATASET.window_size 60 \
    DATASET.pred_len 15 \
    TRAIN.batch_size 8 \
    TRAIN.eval_interval 650 \
    TRAIN.log_interval 600 \
    TRAIN.log_test_interval 80 \
    DEFAULT.exp_name forecasting_exchange_rate_60_15_noscaletest \
